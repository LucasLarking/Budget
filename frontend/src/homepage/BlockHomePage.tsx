        ...
        <div className="bg-[#161a19] p-4 grid grid-rows-3 h-[100vh] gap-[16px] ">
          <div className="hero flex overflow-hidden w-full row-span-2  bg-[#B3F5BC] rounded-[40px] relative ">
            <div className="logInContainer">
              ...
              {accessToken ? (
                <a href="/newdashboard">Min Dashboard</a>
              ) : (
            ...
            <div className="left">
              <a
                href=""
                className="text-2xl font-medium absolute left-20 top-5"
              >
                Larking Budget
              </a>
            ...
            <div className="rigth flex-col flex justify-center">
              <h1 className="text-8xl font-medium">
                <span>Bygg Din</span> <span className="block">Drömbudget</span>
              </h1>
              <a
                className="bg-[#098638] text-xl text-white font-medium  rounded-[40px] w-[270px] h-16 flex items-center justify-center text-center mt-16"
                href="/signup"
              >
                Registrera Dig Idag
              </a>
          ...
          <div className="relavite block-container flex ">
            ...
            <div className="block2">
              <h2 className="text-4xl font-semibold text-black pb-4 w-[500px] p-8">
                Maximera Dina Sparmål - Helt Gratis
              </h2>
            </div>
